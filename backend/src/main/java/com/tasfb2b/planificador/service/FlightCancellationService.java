 ...
 *
 * <p>Encapsula la lógica de:
 * <ol>
 *   <li>Marcar un vuelo como cancelado en la BD</li>
 *   <li>Invalidar el grafo de red (para que Dijkstra no lo reutilice)</li>
 *   <li>Disparar replanificación ALNS si hay una simulación activa</li>
 * </ol>
 */
@Service
